		...
		<h3> Input your grade and interest:</h3>
			<form id="recommendation-form">
				...
				<div class="form-row2">
					...
					<input type="text" id="input-chat" name="interest" placeholder="e.g. I interested in Machine Learning...">
				</div>
				<div class="input-group-append">
					<button class="btn btn-primary" type="button" id="btn-chat">Generate</button>
				</div>
