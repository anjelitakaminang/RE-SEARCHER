    ...
    <div class="sidebar">
        <div class="header">
            ...
            <div class="main">
                ...
                <div class="list-item">
                    <a href="PAGE_I/profile.php">
                        <img src="./pic/user.png" alt="" class="icon">
                        <span class="description">Profile</span>
                    </a>
                </div>
                <div class="list-item">
                    <a href="PAGE_I/grading.php">
    ...
    <div class="main-content">
        ...
        <div class="headbar">
            <div class="menu-profile">
                <ul>
                    <li></li><a  href="PAGE_I/about.html" role="button" lt=""><img src="./pic/about.png" alt="" class="icon"></a></li>
                </ul>
            </div>
            <div class="menu-profile">
                <ul>
                ...
                <form id="recommendation-form">
                    <div class="form-row0">
                        ...
                        <select id="major" name="major">
                            <option>Choose Subject (Informatika) : </option>
