    ...
    <div class="main-content">
        ...
        <div class="headbar">
            <div class="menu-profile">
                <ul>
                    <li></li><a  href="/RE-SEARCHER/PAGE_SI/about.html" role="button" lt=""><img src="/RE-SEARCHER/pic/about.png" alt="" class="icon"></a></li>
                </ul>
            </div>
            <div class="menu-profile">
                <ul>
